...
function shopping(input) {
    ...
    let procesorsCost =  videoCardsCost* 0.35 *videoCards ;
    let ramCost = videoCardsCost * 0.1 * ram;
    let finalCost = videoCardsCost + procesorsCost + ramCost;
    ...
    if (budget >= finalCost) {
        ...
        let neededMoney = finalCost - budget;
