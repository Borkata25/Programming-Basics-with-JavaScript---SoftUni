...
function fishLand(input) {
    let skumriqforKg = parseFloat(input[0]);
    let cacaForKg = parseFloat(input[1]);
    let palamudKg = parseFloat(input[2]);
    let safridKg = parseFloat(input[3]);
    let midiKg = parseFloat(input[4]);
    let palamudPrice = skumriqforKg + skumriqforKg * 0.6;
    let palamudTotal = palamudKg * palamudPrice;
    let safridPrice = cacaForKg + cacaForKg * 0.8;
    let safridTotal = safridKg * safridPrice;
    let midiTotal = midiKg * 7.50;
    let fishTotal = palamudTotal + midiTotal + safridTotal;
    let toFixedAction = fishTotal.toFixed(2);
