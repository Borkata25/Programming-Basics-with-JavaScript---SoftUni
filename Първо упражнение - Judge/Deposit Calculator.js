...
let yearlyFeePercent = parseFloat(input[2]);
let lixvaForYear =depositSum*(yearlyFeePercent/100);
let lixvaForMounth = lixvaForYear/12;
let totalPrice = depositSum +(timeOfDeposit*lixvaForMounth);
